...
class Dsp {
  public:
    ...
    bool     mute            = false;
    bool     reset           = false;
    int8_t   masterVolumeL   = 0;
    int8_t   masterVolumeR   = 0;
    int16_t  noiseSample     = 0;
    uint16_t noiseRate       = 0;
    uint16_t noiseCounter    = 0;
    bool     echoWrites      = false;
    int8_t   echoVolumeL     = 0;
    int8_t   echoVolumeR     = 0;
    int8_t   feedbackVolume  = 0;
    uint16_t echoBufferAdr   = 0;
    uint16_t echoDelay       = 0;
    uint16_t echoRemain      = 0;
    uint16_t echoBufferIndex = 0;
    uint8_t  firBufferIndex  = 0;
  ...
  public:
    ...
    void    dsp_reset();
    void    dsp_cycle();
    void    dsp_handleEcho(int *outputL, int *outputR);
    void    dsp_cycleChannel(int ch);
    void    dsp_handleGain(int ch);
    int16_t dsp_getSample(int ch, int sampleNum, int offset);
  ...
  public:
    const int rateValues[32] = {0,  2048, 1536, 1280, 1024, 768, 640, 512, 384, 320, 256, 192, 160, 128, 96, 80,
                                64, 48,   40,   32,   24,   20,  16,  12,  10,  8,   6,   5,   4,   3,   2,  1};

    const int gaussValues[512] = {
